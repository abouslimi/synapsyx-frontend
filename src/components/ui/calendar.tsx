    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 opacity-70 hover:opacity-100 hover:bg-accent transition-all duration-200 rounded-full"
        ),
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-normal aria-selected:opacity-100 relative transition-all duration-200 hover:scale-105 rounded-lg"
        ),
